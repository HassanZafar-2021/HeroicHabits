...
* Use Node.js and Express.js to create a RESTful API. // Hassan

* Use React for the front end. // Hassan w Help

* Use PostgreSQL and the Sequelize ORM for the database. // Hassan SQL Only
